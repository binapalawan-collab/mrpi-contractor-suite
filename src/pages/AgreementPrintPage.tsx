...
export function AgreementPrintPage({ projectId }: { projectId: string }) {
  ...
  return (
    <div className="print-page-wrap">
      ...
      <article className="print-document agreement-print-document mx-auto overflow-hidden bg-white text-slate-950 shadow-xl">
