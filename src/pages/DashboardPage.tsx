...
const summaries = [
  ...
  { label: 'Projek aktif', value: '0', icon: FolderKanban, tone: 'bg-emerald-50 text-emerald-700' },
  { label: 'Belum dibayar', value: 'RM 0.00', icon: Banknote, tone: 'bg-amber-50 text-amber-700' },
]
