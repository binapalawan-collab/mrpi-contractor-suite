...
function Protected(){return <Switch><Route path="/"><DashboardPage/></Route><Route path="/expenses/baru"><ExpenseFormPage/></Route><Route path="/expenses/:id/edit">{({id})=><ExpenseEditPage expenseId={id}/>}</Route><Route path="/expenses/:id">{({id})=><ExpenseDetailPage expenseId={id}/>}</Route><Route path="/expenses"><ExpenseListPage/></Route><Route path="/projek"><ProjectListPage/></Route><Route path="/pembekal"><SupplierPage/></Route><Route><Redirect/></Route></Switch>}
