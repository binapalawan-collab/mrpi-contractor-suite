...
function Protected(){return <Switch><Route path="/"><DashboardPage/></Route><Route path="/attendance"><AttendancePage/></Route><Route path="/workers"><WorkerPage/></Route><Route path="/wages"><WagePage/></Route><Route path="/history"><HistoryPage/></Route><Route><Redirect/></Route></Switch>}
